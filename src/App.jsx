...
const voteModule = sdk.getVoteModule(
  "0x84a1Da4CF00ef5323f3cFE5A30A0E4fD0db89Ae",
);
...
const App = () => {
  ...
  // Signer, required to write data to the blockchain
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to StonecuttersDAO</h1>
...
if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>🛠️Stonecutters Member Page</h1>
